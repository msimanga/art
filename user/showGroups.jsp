...
<div class="container">
  ...
  <fieldset>
   ...
   <p>
    <table width="90%" align="center" class="table">
	 ...
	 if (request.getParameter("groupId") == null)  {
       ...
       <select id="groupId" name="groupId" size="10" class="form-control">
        <%
	Integer groupId;
   ...
   %>
	  ...
	  <select id="queryId" name="queryId" disabled="disabled" class="form-control" size="10">
	    <option value="">...</option>
	  </select>
	  <br>&nbsp;
      </td>
  ...
  <p align="center">
<input type="submit" id="submitButton" class="btn btn-primary" onClick="javascript:setAction()" onMouseOver="javascript:btndn(this);" onMouseOut="javascript:btnup(this);" style="width:100px;" disabled value="<%=messages.getString("nextButton")%>">
  </p>
  </fieldset>
