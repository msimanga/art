...
<div id="params">
	...
	<div>
		<a href="javascript:showHide(document.getElementById('paramsFieldset'));">Show/Hide Parameters</a>
	</div>
    ...
    <fieldset id="paramsFieldset">
       <!-- <legend><%=messages.getString("enterParams") %></legend>-->
        ...
        <form name="artparameters" id="paramForm" action="<%=action%>"  method="post">
            ...
            <table class="table" align="center" id="paramsTable">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div align="center" valign="middle">
                            <input type="submit" name="execute" id="execute" onClick="javascript:return(<%= validateJS.toString()%> returnTrue() )" class="btn btn-primary" value="<%=messages.getString("executeQueryButton")%>">
                        </div>
                    </td>
                </tr>
            </table>
